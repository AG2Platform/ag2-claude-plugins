---
description: Create a sequential multi-agent pipeline where each agent processes and passes results to the next. Use for step-by-step workflows like extract-transform-load or review chains.
---
