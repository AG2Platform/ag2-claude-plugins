---
description: Create a multi-agent group chat with AG2. Use when you need multiple specialized agents collaborating on a task with configurable speaker selection patterns.
---
