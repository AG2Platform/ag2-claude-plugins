---
description: Design a complete multi-agent workflow from a natural language specification. Analyzes the problem, selects the right orchestration pattern, and generates the full implementation.
---
