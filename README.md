...
| `/sequential-workflow` | Create a sequential pipeline (extract -> transform -> report) |
| `/workflow-from-spec` | Design a complete workflow from a natural language description |
